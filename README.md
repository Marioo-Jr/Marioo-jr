...
**[E-Commerce REST API](https://github.com/YOUR-USERNAME/YOUR-REPO)**
Backend REST API built with Java and Spring Boot, secured with OAuth2/JWT, deployed via a CI/CD pipeline (GitHub Actions → Azure App Service).
